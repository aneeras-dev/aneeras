...
export default function CTABanner() {
  return (
    <section className="py-24 bg-[#EBF0F8] relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-royal-purple/25 to-transparent" />
      <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-royal-purple/25 to-transparent" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <h2 className="font-space font-bold text-5xl sm:text-6xl lg:text-7xl text-[#4259A7] mb-6 tracking-tight leading-[1.05]">
            Let's Build the{' '}
          ...
          <p className="font-inter text-[#4259A7]/60 text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <Link
              href="/about"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl border border-[#4259A7]/20 text-[#4259A7]/80 hover:text-[#4259A7] hover:border-[#4259A7]/40 hover:bg-[#4259A7]/5 font-inter font-medium text-base transition-all duration-300"
            >
              Learn About Us
            </Link>
          </div>
